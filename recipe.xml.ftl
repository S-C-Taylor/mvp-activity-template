...
<recipe>
    ...
    <instantiate from="src/app_package/Contract.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/core/${className}Contract.java" />
    <instantiate from="src/app_package/Activity.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/${className}Activity.java" />
    <instantiate from="src/app_package/Presenter.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/core/${className}Presenter.java" />
   
    <instantiate from="src/app_package/Scope.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/dagger/scopes/${className}ActivityScope.java" />
				   
    <instantiate from="src/app_package/Module.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/dagger/modules/${className}Module.java" />
				   
    <instantiate from="src/app_package/ActivityModule.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/dagger/modules/${className}ActivityModule.java" />	

    <instantiate from="src/app_package/ActivityComponent.java.ftl"
                   to="${escapeXmlAttribute(srcOut)}/dagger/components/${className}ActivityComponent.java" />	
